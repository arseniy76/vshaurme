...
Далее создайте базу данных командой (https://python manage.py migrate/). Вам нужно будет повторять эту команду, если вы будете скачивать обновления нашего кода, в которых база данных будет меняться.
